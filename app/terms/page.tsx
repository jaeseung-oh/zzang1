    ...
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-10 text-[#0f172a] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl rounded-[2rem] border border-[#d7dee8] bg-white p-8 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
        ...
        <div className="mt-8 space-y-6 text-sm leading-8 text-slate-700">
          ...
          <section><h2 className="text-lg font-bold text-slate-950">제4조 결제 및 환불</h2><p className="mt-2">음주운전 예방교육의 상품제공기간은 결제 완료 즉시 제공이며 온라인상품 구매 후 바로 사용 가능합니다. 수강기간은 결제일로부터 90일입니다. 결제 완료 즉시 수강권이 부여되며, 환불은 실제 결제금액에서 미수강 강의 수가 전체 강의 수에서 차지하는 비율을 기준으로 산정합니다. 전체 5강 수강 즉시 수료증 등 자료 출력이 가능하며, 출력 이후 환불 제한 조건은 별도 환불규정에 따릅니다.</p></section>
