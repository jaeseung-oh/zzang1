...
const packs: Record<PreventionDocumentCategory, CourseDocumentPack> = {
  ...
  drug: {
    "prevention-plan": { heading: "마약류중독 재활예방계획서", purpose: ["본인은 마약류 사용과 재사용 위험이 본인과 주변 사람의 안전, 건강, 신뢰 관계를 훼손할 수 있음을 인정합니다.", "본 계획서는 재사용 위험 상황, 접근 경로, 회복 지원 체계를 점검하고 재활과 재발방지를 위한 구체적인 실천 계획을 정리하기 위해 작성합니다."], sections: [{ title: "재사용 위험 요인 분석", items: ["스트레스, 외로움, 수치심 등 감정이 커지는 시간", "과거 사용 장소, 연락처, 온라인 접근 경로", "술자리나 늦은 밤처럼 판단력이 낮아지는 상황", "치료·상담·가족 지원에서 멀어지는 생활 패턴"] }, { title: "구체적인 재활예방계획", items: ["관련 연락처와 접근 경로를 차단하겠습니다.", "상담, 치료, 자조모임 등 회복 지원 일정을 유지하겠습니다.", "고위험 시간이 오면 혼자 있지 않고 신뢰할 수 있는 사람에게 연락하겠습니다.", "수면, 식사, 운동 등 생활 루틴을 기록하고 점검하겠습니다."] }], closing: ["본인은 회복을 의지에만 맡기지 않고 접근 차단, 지원 요청, 생활 점검을 지속하겠습니다."] },
    "action-plan": { heading: "마약류 재활 실천계획서", purpose: ["본 계획서는 재사용 위험을 낮추기 위해 매일 실천할 생활 기준과 도움 요청 방법을 미리 정하기 위해 작성합니다."], sections: [{ title: "일상 관리 기준", items: ["수면과 식사 시간을 일정하게 유지하겠습니다.", "상담·치료 일정을 빠뜨리지 않겠습니다.", "위험 연락처와 장소를 피하겠습니다.", "충동이 올라오면 30분 지연 후 도움을 요청하겠습니다."] }, { title: "도움 요청 계획", items: ["가족 또는 조력자에게 현재 상태를 알리겠습니다.", "위험 상황에서는 혼자 해결하려 하지 않겠습니다.", "필요 시 상담기관 또는 의료기관에 연락하겠습니다."] }], closing: ["본인은 재활과 회복을 위한 실천 계획을 매일 점검하겠습니다."] },
    pledge: { heading: "마약류중독 재활예방 서약서", purpose: ["본인은 마약류에 다시 접근하지 않고 회복을 위한 생활 기준을 지킬 것을 서약합니다."], sections: [{ title: "구체적 서약사항", items: ["마약류를 구매, 보관, 사용하지 않겠습니다.", "관련 연락처와 온라인 접근 경로를 차단하겠습니다.", "재사용 충동이 생기면 즉시 도움을 요청하겠습니다.", "상담과 치료, 회복 지원 일정을 성실히 지키겠습니다."] }], closing: ["본인은 위 서약을 지키며 회복과 재발방지를 위해 지속적으로 노력하겠습니다."], signatureLabel: "서약자", extraSignature: true },
  },
  "sexual-offense": {
