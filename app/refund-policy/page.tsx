...
const refundTable = [
  ["수강 전", "0강 수강 / 5강 미수강", "55,000원"],
  ["1강 수강 후", "4강 미수강", "44,000원"],
  ["2강 수강 후", "3강 미수강", "33,000원"],
  ["3강 수강 후", "2강 미수강", "22,000원"],
  ["4강 수강 후", "1강 미수강", "11,000원"],
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <section className="rounded-[2rem] border border-[#d7dee8] bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-7 text-slate-700">
            ...
            <li>환불금액 산정 기준: 미수강 강의 수 × 11,000원</li>
          </ul>
        </section>
        ...
        <section className="rounded-[2rem] border border-[#d7dee8] bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
          <div className="space-y-2 text-sm leading-7 text-slate-700">
            <p>※ 본 교육과정은 총 5강으로 구성되어 있으며, 총 수강료는 55,000원입니다.</p>
            <p>※ 1강당 환불 산정금액은 11,000원입니다.</p>
