...
export const metadata: Metadata = {
  title: "재발방지계획서 작성방법과 실천항목 | ResetEdu Prevention Education Center",
  description: "사건 발생 원인, 반복 위험상황, 구체적인 행동수칙과 생활 실천계획을 직접 정리하는 방법을 안내합니다.",
  alternates: { canonical: "/guides/prevention-plan/" },
  openGraph: { title: "재발방지계획서 작성방법과 실천항목 | ResetEdu Prevention Education Center", description: "사건 발생 원인, 반복 위험상황, 구체적인 행동수칙과 생활 실천계획을 직접 정리하는 방법을 안내합니다.", url: "/guides/prevention-plan/", type: "article" },
};
