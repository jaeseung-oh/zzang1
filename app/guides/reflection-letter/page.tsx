...
export const metadata: Metadata = {
  title: "반성문 작성방법과 참고할 내용 | ResetEdu Prevention Education Center",
  ...
  openGraph: { title: "반성문 작성방법과 참고할 내용 | ResetEdu Prevention Education Center", description: "반성문 작성순서, 잘못에 대한 인식, 피해와 위험에 대한 이해, 재발방지 행동계획을 본인의 경험에 맞게 정리하는 방법을 안내합니다.", url: "/guides/reflection-letter/", type: "article" },
};
