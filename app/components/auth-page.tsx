...
const modeCopy = {
  ...
  login: {
    ...
    intro:
      "이미 가입한 회원은 로그인 후 강의실, 내 수강현황, 수료증 발급 화면으로 이동할 수 있습니다.",
    benefits: [
    ...
    submitLabel: "로그인",
    helperTitle: "이용 안내",
    helperBody: "로그인한 계정은 강의실 입장과 수료증 발급 흐름을 바로 이용할 수 있습니다.",
  },
} as const;
...
function getAuthErrorMessage(error: unknown, fallback = "요청 처리 중 문제가 발생했습니다. 잠시 후 다시 시도해 주세요.") {
  ...
  switch (code) {
    case "auth/too-many-requests":
      return "Firebase 보안 제한으로 요청이 잠시 차단되었습니다. 10~30분 후 다시 시도하고, 계속 반복되면 다른 네트워크에서 시도하거나 고객센터에 문의해 주세요.";
    ...
    case "auth/invalid-continue-uri":
      return "요청 완료 후 이동 주소 형식이 올바르지 않습니다. 관리자에게 도메인 설정을 요청해 주세요.";
    case "auth/missing-continue-uri":
      return "요청 완료 후 이동 주소가 누락되었습니다. 관리자에게 도메인 설정을 요청해 주세요.";
