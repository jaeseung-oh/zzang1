...
export const buttonVariants: Record<ButtonVariant, string> = {
  primary: "border-2 border-[#173968] bg-[#173968] text-white hover:border-[#10213f] hover:bg-[#10213f] hover:text-white hover:shadow-md disabled:border-gray-400 disabled:bg-gray-300 disabled:text-gray-800",
