...
export function AccessDeniedCard({ title = "접근할 수 없습니다.", message, primaryHref = "/courses/apply", primaryLabel = "교육 신청하기", secondaryHref = "/", secondaryLabel = "홈으로 이동" }: { title?: string; message: string; primaryHref?: string; primaryLabel?: string; secondaryHref?: string; secondaryLabel?: string }) {
  return (
