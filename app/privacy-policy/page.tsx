    ...
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-10 text-[#0f172a] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl rounded-[2rem] border border-[#d7dee8] bg-white p-8 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
        ...
        <div className="mt-8 space-y-6 text-sm leading-8 text-slate-700">
          ...
          <section><h2 className="text-lg font-bold text-slate-950">이용자 권리</h2><p className="mt-2">이용자는 자신의 개인정보에 대해 열람, 정정, 삭제, 처리정지 등을 요청할 수 있으며, 관련 문의는 리셋 재범방지교육센터 고객센터 010-7727-8619로 접수할 수 있습니다.</p></section>
          <section><h2 className="text-lg font-bold text-slate-950">개인정보 보호책임자 및 문의</h2><p className="mt-2">개인정보 보호책임자 및 민원처리 담당자는 대표자 홍경자이며, 문의 연락처는 010-7727-8619입니다.</p></section>
        </div>
      </div>
    </main>
  );
