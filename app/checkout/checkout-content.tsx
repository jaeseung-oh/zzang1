          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
              ...
              <div className="mt-5 sm:mt-6">
                ...
                <div className="mt-3 grid gap-3 lg:grid-cols-3">
                  {selectedCategory.products.map((product) => {
                    ...
                    const fallbackIncludes = ["온라인 재범방지교육", "교육 수료증 PDF 발급", ...courseDocumentTitles, ...(isAdvancedProduct ? ["반성문 작성자료", "인지행동기반 재발방지교육 이수증", "재범방지 교육 이수 상세 내역서"] : []), "인쇄 및 PDF 저장"];
            ...
            <div className="mt-4 rounded-2xl border border-[#d3b271]/45 bg-[#fffaf0] p-4 sm:p-5">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-700">
                {selectedCourseDefinition ? `${selectedCourseTitle} 결제 완료 후 ${selectedResourceLabel}을 이용할 수 있습니다.` : selectedProduct.id === "dui-cbt-advanced" ? "결제 완료 후 음주운전 재범방지교육과 인지행동 개선교육을 모두 수강하고 수료증, 3종 작성자료, 이수증, 상세 내역서를 출력할 수 있습니다." : selectedProduct.id === "dui-documents" ? "결제 완료 후 재발방지 관련 3종 작성자료와 반성문 작성자료를 열람하고 인쇄하거나 PDF로 저장할 수 있습니다." : "결제 완료 후 반성문 작성 가이드와 음주운전 반성문 예시를 열람하고 인쇄하거나 PDF로 저장할 수 있습니다."}
              </p>
            </div>
          </article>
