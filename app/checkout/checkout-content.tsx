          ...
          : {
              bypass: {
                kcp_v2: {
                  ...
                  kcp_pay_title: "ResetEdu 재범방지교육 결제",
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
            ...
            <div className="mt-4 rounded-2xl border border-[#d3b271]/45 bg-[#fffaf0] p-4 sm:p-5">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-700">
                {selectedCourseDefinition ? `${selectedCourseTitle} 결제 완료 후 ${selectedResourceLabel}을 이용할 수 있습니다.` : selectedProduct.id === "dui-cbt-advanced" ? "결제 완료 후 음주운전 재범방지교육과 인지행동 개선교육을 모두 수강하고 수료증, 3종 서식, 이수증, 상세 내역서를 출력할 수 있습니다." : selectedProduct.id === "dui-documents" ? "결제 완료 후 재발방지 관련 3종 서식과 반성문 작성 서식을 열람하고 인쇄하거나 PDF로 저장할 수 있습니다." : "결제 완료 후 반성문 작성 가이드와 음주운전 반성문 예시를 열람하고 인쇄하거나 PDF로 저장할 수 있습니다."}
              </p>
            </div>
          </article>
