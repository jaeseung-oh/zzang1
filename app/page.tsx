      ...
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-6 lg:grid-cols-[minmax(0,1fr)_420px] lg:px-8 lg:py-20">
          <div className="min-w-0">
            ...
            <h1 className="mt-6 max-w-4xl text-3xl font-black leading-tight text-white sm:text-5xl lg:text-6xl">사건 이후 필요한 예방교육과 재발방지 자료를 한곳에서 준비하세요</h1>
            <p className="mt-5 max-w-3xl text-base leading-relaxed text-slate-100 sm:text-xl">자신의 잘못과 위험상황을 돌아보고 같은 문제가 반복되지 않도록 교육 이수 기록과 구체적인 실천계획을 체계적으로 정리할 수 있도록 돕습니다.</p>
            <p className="mt-4 max-w-3xl text-sm leading-relaxed text-slate-200 sm:text-base">현재는 음주운전 예방교육을 운영하며, 온라인 수강과 수강 즉시 수료증 출력, 반성문 작성 가이드, 재발방지계획서·실천계획서·서약서 참고서식을 제공합니다.</p>
            <div className="mt-8 flex flex-wrap gap-3"><Link href={applyHref} style={{ backgroundColor: "#ffffff", color: "#0f172a" }} className={buttonClass("darkPrimary", "lg", "whitespace-nowrap rounded-full px-7 font-black focus:ring-offset-[#10213f]")}>내게 필요한 과정 확인하기</Link><Link href="/courses" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", minHeight: "56px", padding: "0 28px", borderRadius: "9999px", backgroundColor: "#facc15", color: "#111827", border: "2px solid #fde047", fontWeight: 900, boxShadow: "0 16px 32px rgba(250, 204, 21, 0.28)" }} className={buttonClass("darkSecondary", "lg", "whitespace-nowrap rounded-full px-7 focus:ring-offset-[#10213f]")}>강의 구성 보기</Link></div>
          </div>
