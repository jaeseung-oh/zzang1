...
export const metadata: Metadata = {
  title: "ResetEdu 재발방지교육센터 | 온라인 재범방지교육과 양형자료 준비",
  description: "사건 이후 온라인 재범방지교육을 수강하고 재발방지 실천계획, 생활개선 자료, 교육 이수 자료를 체계적으로 정리하세요.",
  alternates: { canonical: "/" },
  openGraph: {
    title: "ResetEdu 재발방지교육센터 | 온라인 재범방지교육과 양형자료 준비",
    description: "온라인 재범방지교육부터 양형자료 준비를 위한 실천자료까지 한 번에 확인하세요.",
...
const practiceKeywords = ["양형자료 준비", "재발방지", "생활개선", "재범방지교육", "실천기록", "자기점검", "교육 이수 및 실천자료 관리"];
        ...
        <section className="relative overflow-hidden bg-[#edf4f8] md:min-h-0">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-6 px-4 pb-7 pt-6 sm:px-6 md:gap-10 md:py-14 lg:grid-cols-[minmax(0,0.95fr)_minmax(420px,1.05fr)] lg:px-8 lg:py-20">
            <div className="flex min-w-0 flex-col justify-center">
              ...
              <h1 className="mt-3 max-w-3xl text-[2rem] font-black leading-[1.16] text-slate-950 sm:text-5xl lg:text-[52px]">온라인 재범방지교육부터<br />양형자료 준비까지</h1>
