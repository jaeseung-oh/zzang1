      ...
      <section className="relative overflow-hidden bg-[#06101b] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-28 sm:px-6 lg:px-8 lg:pb-20 lg:pt-32">
          ...
          <div className="mt-10 max-w-4xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/courses/apply?category=dui" style={{ backgroundColor: "#facc15", color: "#111827", border: "2px solid #fde047", boxShadow: "0 18px 36px rgba(250,204,21,0.28)" }} className={buttonClass("darkPrimary", "lg", "whitespace-nowrap rounded-full px-7 font-black focus:ring-offset-[#06101b]")}>
                음주운전 교육 수강 신청
              </Link>
              <Link href="/courses/apply?category=dui&productId=dui-documents" className={buttonClass("darkSecondary", "lg", "whitespace-nowrap rounded-full px-7 font-bold focus:ring-offset-[#06101b]")}>
                3종 서식 포함 과정 보기
              </Link>
            </div>
          </div>
