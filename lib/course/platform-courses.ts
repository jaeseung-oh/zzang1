...
export const commonFaqs = [
  ...
  ["기본과정과 심화과정의 차이는 무엇인가요?", "기본과정에는 사건 유형별 예방교육과 수료증, 과정별 재발방지계획서 서식, 실천계획서 서식, 재발방지 서약서 서식이 포함됩니다. 심화과정은 같은 3종 서식에 반성문 작성 서식, 인지행동기반 재발방지교육 이수증, 상세 내역서 출력 구성이 추가됩니다."],
