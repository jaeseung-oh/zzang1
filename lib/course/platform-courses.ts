...
export const platformCourseCategories: CourseCategory[] = [
  ...
  },
  {
    ...
    availableDocuments: ["폭력범죄 재범방지교육 수료증", "폭력범죄 재범방지계획서 서식", "폭력예방 실천계획서 서식", "폭력범죄 재범방지 서약서 서식", "인지행동기반 재발방지교육 이수증: 심화과정에 한함"],
  ...
  },
  {
    ...
    availableDocuments: ["도박중독 재발방지교육 수료증", "도박중독 재발방지계획서 서식", "도박예방 실천계획서 서식", "도박중독 재발방지 서약서 서식", "인지행동기반 재발방지교육 이수증: 심화과정에 한함"],
  ...
  },
  {
    ...
    availableDocuments: ["성범죄 재범방지교육 수료증", "성범죄 재범방지계획서 서식", "성범죄예방 실천계획서 서식", "성범죄 재범방지 서약서 서식", "인지행동기반 재발방지교육 이수증: 심화과정에 한함"],
...

  {
    ...
    availableDocuments: [
      ...
      "재발방지계획서: 심화과정에 한함",
      "실천서약서: 심화과정에 한함",
      "고위험 상황 대처계획서: 심화과정에 한함",
      "마약 사용 유발요인 점검표: 심화과정에 한함",
      "갈망 대처계획: 심화과정에 한함",
      "월간 자기점검표: 심화과정에 한함",
    ],
...
export const commonFaqs = [
  ...
  ["기본과정과 심화과정의 차이는 무엇인가요?", "기본과정에는 사건 유형별 재범방지교육과 수료증, 과정별 재발방지계획서 서식, 실천계획서 서식, 재발방지 서약서 서식이 포함됩니다. 심화과정은 같은 3종 서식에 반성문 작성 서식, 인지행동기반 재발방지교육 이수증, 상세 내역서 출력 구성이 추가됩니다."],
