...
export const introCourses: IntroCourse[] = [
  {
    ...
    audience: ["음주운전 사건 이후 자발적 교육 이수 자료가 필요한 분", "금주 계획과 재발방지 노력을 문서로 정리하려는 분", "방문 없이 온라인으로 교육과 참고서식을 준비하려는 분"],
    outcomes: ["음주 위험성 인식과 책임 의식 정리", "금주 실천 계획 작성 방향 확인", "재발방지 생활 관리 계획 정리"],
    documents: ["교육 이수 확인 자료", "금주실천서약서 참고 양식", "재발방지계획서 참고 양식"],
  ...
  },
  {
    ...
    audience: ["사기 관련 사건 이후 재발방지 노력을 정리해야 하는 분", "거래 윤리와 문서 책임을 다시 점검하려는 분", "교육 이수 자료와 계획서 참고 양식이 필요한 분"],
    outcomes: ["거래 과정의 책임 인식 정리", "피해 회복과 신뢰 회복 방향 점검", "재발방지 실천 계획 구성"],
    documents: ["교육 이수 확인 자료", "재발방지계획서 참고 양식", "책임 점검 체크리스트"],
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=1600&q=80",
    tags: ["문서 책임", "신뢰 회복", "계획 수립"],
  },
  {
    slug: "gambling-prevention",
    title: "도박 예방 교육",
    shortTitle: "도박",
    headline: "도박 문제를 돌아보고 재발방지 실천 계획을 온라인으로 정리하세요.",
    summary: "도박 위험성, 충동 관리, 금전 관리, 재발방지 환경 조성을 중심으로 구성한 교육입니다. 자신의 행동을 돌아보고 향후 실천 계획을 자료 형태로 정리할 수 있도록 돕습니다.",
    ...
    documents: ["교육 이수 확인 자료", "재발방지계획서 참고 양식", "생활 관리 계획 참고 양식"],
  ...
  },
  {
    ...
    documents: ["교육 이수 확인 자료", "재발방지계획서 참고 양식", "회복 실천 계획 참고 양식"],
    image: "https://images.unsplash.com/photo-1579154341098-e4e158cc7f55?auto=format&fit=crop&w=1600&q=80",
    tags: ["위험성 인식", "회복 계획", "재발방지"],
  },
  {
    slug: "sexual-crime-prevention",
    title: "성범죄 예방 교육",
    shortTitle: "성범죄",
    headline: "관계 윤리와 경계 인식을 점검하고 책임 있는 재발방지 계획을 정리하세요.",
    ...
    documents: ["교육 이수 확인 자료", "재발방지계획서 참고 양식", "관계 윤리 점검표"],
  ...
  },
  {
    ...
    title: "폭력 예방 교육",
    shortTitle: "폭력",
    headline: "분노 조절과 책임 의식을 점검하고 재발방지 계획을 준비하세요.",
    summary: "갈등 상황, 감정 조절, 피해 인식, 재발방지 행동 계획을 정리하는 온라인 교육입니다. 폭력 사건 이후 자발적인 개선 노력을 자료로 정리하려는 분에게 맞춘 구성입니다.",
    ...
    documents: ["교육 이수 확인 자료", "재발방지계획서 참고 양식", "감정 관리 계획 참고 양식"],
  ...
  },
  {
    ...
    documents: ["교육 이수 확인 자료", "재발방지계획서 참고 양식", "생활 개선 계획 참고 양식"],
