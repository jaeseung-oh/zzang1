...
const newPreventionApplicationProducts = new Map<string, ApplicationProduct>([
  ...
  ["digital-crime-advanced", {
    ...
    includes: ["디지털범죄 재범방지교육 온라인 강의", "진도율 확인", "디지털범죄 재범방지교육 심화과정 수료증 PDF 발급", "디지털범죄 재발방지계획서", "디지털범죄 재범방지 실천계획서", "디지털범죄 재범방지 실천서약서", "반성문 작성자료", "재범방지 교육 이수 상세 내역서", "모바일 및 PC 수강", "결제 후 즉시 수강 가능"],
  }],
]);
