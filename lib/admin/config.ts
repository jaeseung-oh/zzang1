...
export const adminSettings = {
  siteName: process.env.NEXT_PUBLIC_SITE_NAME || "리셋에듀센터",
  operatorName: process.env.NEXT_PUBLIC_OPERATOR_NAME || "리셋에듀센터",
  businessName: process.env.NEXT_PUBLIC_BUSINESS_NAME || "리셋에듀센터",
